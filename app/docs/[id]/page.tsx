...
export default function DocDetail({ params }: Props) {
  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-6 py-10 flex justify-center">
        <div className="relative bg-white p-6 rounded-lg shadow-lg w-[770px]">
          {/* Document Header */}
          ...
          {!isSignedIn && (
            <div className="absolute inset-0 flex items-center justify-center bg-white/60 backdrop-blur-md rounded-lg">
              <div className="text-center">
                <p className="text-lg font-semibold">Sign Up To View The Full Document!</p>
                <SignUpButton>
